(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsServerItemServerItemComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsMainMenuMainMenuComponentLess(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppComponentsMainMenuMainMenuComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Models_UsageTimeStruct__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../Models/UsageTimeStruct */
    ...
    let MainMenuComponent = class MainMenuComponent {
      constructor(http) {
        this.http = http;
        this.serverList = [];
        this.apiUrl = "".concat(_constants__WEBPACK_IMPORTED_MODULE_2__["GLobalConstants"].apiPortUrl, "/api");
        this.localization = {
          Id: "VirtualServerId",
      ...
      setTimes() {
        this.getTotalUsageTime().subscribe(p => {
        ...
        this.getCurrentTime().subscribe(p => {
          this.currentTime = p;
      ...
      setServers() {
        const serversSubscriber = this.getServers().subscribe(p => {
          this.serverList = [];
      ...
      getServerVmDate(time) {
        ...
        const [{
          ...
          value: SS
        }] = dtf.formatToParts(time);
        console.log("".concat(ye, "-").concat(mo, "-").concat(da));
        return "".concat(ye, "-").concat(mo, "-").concat(da, " ").concat(HH, ":").concat(MM, ":").concat(SS);
      }

      getServers() {
        const methodUrl = '';
        return this.http.get("".concat(this.apiUrl, "/").concat(methodUrl));
      }

      addServer() {
        this.doAddServer().subscribe(p => {
          this.setServers();
          this.setTimes();
        });
      }
      ...
      removeAll() {
        ...
        this.doRemoveAll(idForRemoveList).subscribe(p => {
          this.setServers();
          this.setTimes();
        });
      }
      ...
      doRemoveAll(idList) {
        ...
        return this.http.post("".concat(this.apiUrl, "/").concat(methodUrl), idList);
      }
    ...
    MainMenuComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      /*! ./main-menu.component.less */
      "./src/app/Components/main-menu/main-menu.component.less")).default]
    })], MainMenuComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsServerItemServerItemComponentLess(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsServerItemServerItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ServerItemComponent", function () {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], ServerItemComponent.prototype, "server", void 0);
    ServerItemComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'server-item',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./server-item.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/Components/server-item/server-item.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./server-item.component.less */
      "./src/app/Components/server-item/server-item.component.less")).default]
    })], ServerItemComponent);
    /***/
  },
  ...
  /***/
  function srcAppModelsUsageTimeStructTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "UsageTimeStruct", function () {
      return UsageTimeStruct;
    });
    /* harmony import */
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Components_server_item_server_item_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./Components/server-item/server-item.component */
    "./src/app/Components/server-item/server-item.component.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _Components_server_item_server_item_component__WEBPACK_IMPORTED_MODULE_5__["ServerItemComponent"], _Components_main_menu_main_menu_component__WEBPACK_IMPORTED_MODULE_6__["MainMenuComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forRoot([{
        path: '',
  ...
  function srcAppConstantsIndexTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "GLobalConstants", function () {
      return _global_constants__WEBPACK_IMPORTED_MODULE_1__["GLobalConstants"];
    });
    /***/
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/partitski/ASP.NET Core/VirtualServer/VirtualServer/VirtualServer/Frontend/virtual-server-app/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
